...
RESULTS_DIR=/home/arch/Desktop/shared/optim/hmmer
mkdir -p $RESULTS_DIR
...
# Benchmark-specific settings for spechmmer
BENCHMARK="spechmmer"
BINARY_PATH="spec_cpu2006/456.hmmer/src"
INPUT_ARGS="--fixed 0 --mean 325 --num 45000 --sd 200 --seed 0 spec_cpu2006/456.hmmer/data/bombesin.hmm"
CPU_CLOCK="1GHz"
