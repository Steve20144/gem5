...
RESULTS_DIR=/home/arch/Desktop/shared/optim/bzip/new
mkdir -p $RESULTS_DIR
...
L1_INST_SIZES="64kB" # L1 Instruction Cache Size
L1_DATA_SIZES=("64kB" "128kB") # L1 Data Cache Size
L2_SIZES=("2MB" "4MB")        # L2 Cache Size
CACHE_LINES=128          # Cache Line Size
 
# Benchmark-specific settings for specbzip
BENCHMARK="specbzip"
BINARY_PATH="spec_cpu2006/401.bzip2/src"
INPUT_ARGS="spec_cpu2006/401.bzip2/data/input.program 10"
CPU_CLOCK="1GHz"
...
for L2_SIZE in "${L2_SIZES[@]}"; do
    for L1_DATA_SIZE in "${L1_DATA_SIZES[@]}"; do
                ...
                --l1d_size=${L1_DATA_SIZE} --l1i_size=${L1_INST_SIZES} \
